...
const Portfolio: React.FC = () => {
  ...
  const account = router.query.address[0]
        ...
        <DoubleGlowShadow maxWidth={false} opacity={'0.6'}>
          <div className="flex-col items-center gap-10 justify-center w-full">
            <div className="flex justify-between bg-blue p-6">
              <div className="text-white">Displaying data for {shortenAddress(account)}</div>
              {account && (
                ...
                <ExternalLink
                  ...
                  href={getExplorerLink(chainId, "asd", 'transaction')}
                >
                  <div className="flex flex-row items-center gap-1 text-aqua">
                    {i18n._(t`View another address`)} <ExternalLinkIcon width={20} height={20} />
                  </div>
                </ExternalLink>*/}
                </div>
              )}
