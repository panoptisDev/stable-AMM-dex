  ...
  const modalHeader = () => {
    return noLiquidity ? (
      ...
      <div className="pb-4 pr-5 pl-5">
        ...
        <div className="pt-3 text-xs italic text-jordyBlue">
          ...
          <div className="p-4 space-y-4 rounded-sm bg-blue" style={{ zIndex: 1 }}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                <div className="p-1 rounded-sm bg-deepCove">
                  <LiquidityPrice
                    currencies={currencies}
                    price={price}
                    noLiquidity={noLiquidity}
                    poolTokenPercentage={poolTokenPercentage}
                    className="bg-deepCove text-jordyBlue"
                  />
                </div>
              )}

              {addIsUnsupported ? (
                <Button className="bg-linear-gradient" style={{ height: 55 }} color="gradient" size="lg" disabled>
