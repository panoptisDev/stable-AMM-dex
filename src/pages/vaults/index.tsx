...
// import { usePositions, useglintVaultInfo, useVaults } from '../../features/vault/hooks'
...
// import { GLINT_ADDRESS, AVERAGE_BLOCK_TIME, WNATIVE } from '../../constants'
...
//   const distributorInfo = useglintVaultInfo()
...
//         ((pool.allocPoint / distributorInfo.totalAllocPoint) * distributorInfo.glintPerBlock) / 1e18

//       const defaultReward = {
//         token: 'GLINT',
//         icon: '/images/token/glint.png',
//         rewardPerBlock,
...
//       let lpPrice = 0
//       let decimals = 18
//       if (pool.lpToken == GLINT_ADDRESS[chainId]) {
//         lpPrice = glintPrice
...
//     return previousValue + (currentValue.amount / 1e18) * glintPrice
//   }, 0)

//   return (
//     <>
//       <Head>
//         <title>Vaults | Beamswap</title>
//         <meta key="description" name="description" content="glint Vaults" />
//       </Head>
...
//                         <div className="mb-2 text-2xl text-emphesis">{i18n._(t`glint Vault`)}</div>
//                         <div className="mb-4 text-white text-secondary">
//                           <p>
//                             {i18n._(
//                               t`glint Vault is a set of high incentivized pools. Long term supporters can choose to lock GLINT for a determined period for higher rewards.`
//                             )}
//                           </p>
//                           <p className="mt-2">
//                             {i18n._(
//                               t`The participants receive various benefits such as higher rewards according to lock duration, higher allocations in glint Launchpad and more.`
//                             )}
//                           </p>
//                         </div>
