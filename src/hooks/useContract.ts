...
import ANYSWAPV3_ERC20_ABI from '../constants/abis/anyswap_erc20_v3.json'
...
import BEAM_DISTRIBUTOR_ABI from '../constants/abis/beam-distributor.json'
import BEAM_VAULT_ABI from '../constants/abis/beam-vault.json'
import BEAM_LOCKER_ABI from '../constants/abis/beam-locker.json'
...
import BEAMSHARE_ABI from '../constants/abis/BeamShare.json'
import SHAREFARM_ABI from '../constants/abis/sharefarm.json'
import BLO_ABI from '../constants/abis/blo.json'
import BEANS_BLO_ABI from '../constants/abis/beansblo.json'
...
export function useContractBlastRpc(address: string | undefined, ABI: any, withSignerIfPossible = true): Contract | null {
  const { library, account } = useActiveWeb3React()
...
export function useBloContract(tokenAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(tokenAddress, BLO_ABI, withSignerIfPossible)
}

export function useBeansBloContract(tokenAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(tokenAddress, BEANS_BLO_ABI, withSignerIfPossible)
}

export function useVestingContract(vestingAddress?: string, withSignerIfPossible?: boolean): Contract | null {
...
export function useAnyswapTokenContractV3(tokenAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(tokenAddress, ANYSWAPV3_ERC20_ABI, withSignerIfPossible)
}
...
export function useBeamShareContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(SHARE_ADDRESS[chainId], BEAMSHARE_ABI, withSignerIfPossible)
}
...
export function useBeamDistributorContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && BEAMCHEF_ADDRESS[chainId], BEAM_DISTRIBUTOR_ABI, withSignerIfPossible)
}

export function useShareFarmContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && SHAREFARM_ADDRESS[chainId], SHAREFARM_ABI, withSignerIfPossible)
}

export function useBeamVaultContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && BEAM_VAULT_ADDRESS[chainId], BEAM_VAULT_ABI, withSignerIfPossible)
}

export function useLockerContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && LOCKER_ADDRESS[chainId], BEAM_LOCKER_ABI, withSignerIfPossible)
}

export function useglintGlimmerContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && GLINT_GLMR_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useBeansGlmrContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && BEANS_GLMR_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useGlmrUsdcContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && GLMR_USDC_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useCgsUsdcContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && CGS_USDC_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useIdoContract(address: string | undefined, withSignerIfPossible?: boolean): Contract | null {
  return useContract(address, IDO_ABI, withSignerIfPossible)
}

export function useIdoContractBlast(address: string | undefined, withSignerIfPossible?: boolean): Contract | null {
  return useContractBlastRpc(address, IDO_ABI, false)
}
...
export function useEthUsdcContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && ETH_USDC_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}
...
export function useBifiGlmrContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && BIFI_GLMR_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useWbtcUsdcContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && WBTC_USDC_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}
...
export function useGlintContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && GLINT_ADDRESS[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useMasterChefV2Contract(withSignerIfPossible?: boolean): Contract | null {
  return useContract('0xF774C205a48ad0BEf7F62948FB69B31A8440e534', MASTERCHEF_V2_ABI, withSignerIfPossible)
}
