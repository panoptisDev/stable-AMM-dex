...
const ENTER_BEAMSHARE_PERMIT_INFO: PermitInfo = {
  version: '1',
  name: 'BeamSwap',
  type: PermitType.AMOUNT,
}
...
export function useBeamSharePermit(
  liquidityAmount: CurrencyAmount<Token> | null | undefined,
  spender: string | null | undefined
) {
  return useERC20Permit(liquidityAmount, spender, ENTER_BEAMSHARE_PERMIT_INFO)
}
