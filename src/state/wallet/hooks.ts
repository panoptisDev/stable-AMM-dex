...
export function useMultichainCurrencyBalanceFTM(
  chainId?: number,
  account?: string,
  currency?: Currency
): CurrencyAmount<Currency> | undefined {
  ...
  const getBalance = useCallback(() => {
    ...
    if (currency.wrapped.address == '0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83') {
  ...
  return useMemo(() => {
    return chainId == moonriverChainId ? value : moonriverBalance
