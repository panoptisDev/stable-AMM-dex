...
export function ConfirmAddModalBottom({
  ...
  return (
    <div className="p-6 mt-0 rounded-sm bg-deepCove pr-5 pl-5">
      ...
      <div className="h-px my-6 bg-lightBlueSecondary" />
      <div className="grid gap-1 pb-6">
        <div className="flex items-center justify-between">
          <div className="text-sm text-jordyBlue">{i18n._(t`${currencies[Field.CURRENCY_A]?.symbol} Deposited`)}</div>
          <div className="text-sm font-bold justify-center items-center flex right-align pl-1.5 text-high-emphesis">
        ...
        <div className="flex items-center justify-between">
          <div className="text-sm text-jordyBlue">{i18n._(t`${currencies[Field.CURRENCY_B]?.symbol} Deposited`)}</div>
          <div className="text-sm font-bold justify-center items-center flex right-align pl-1.5 text-high-emphesis">
        ...
        <div className="flex items-center justify-between">
          <div className="text-sm text-jordyBlue">{i18n._(t`Share of Pool:`)}</div>
          <div className="text-sm font-bold justify-center items-center flex right-align pl-1.5 text-high-emphesis">
      ...
      <Button color="gradient" size="lg" onClick={onAdd} style={{height: 57}} className='bg-linear-gradient'>
