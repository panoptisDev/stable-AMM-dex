...
export default function SwapModalHeader({
  ...
  return (
    <div className="grid gap-4 pr-5 pl-5">
      <div className="grid gap-2 bg-deepCove p-2 rounded-md">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div
              className={`overflow-ellipsis w-[190px] overflow-hidden font-bold text-2xl ${
