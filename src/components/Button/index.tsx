...
const SIZE = {
  ...
  sm: 'px-4 py-2 text-white',
  default: 'px-4 py-3 text-white',
  lg: 'px-6 py-4 text-white',
  none: 'p-0 text-white',
  nobase: 'px-4 py-3',
}

const FLEXED = {
  default: 'bg-transparent opacity-100',
  ...
  pink: 'bg-gradient-to-r from-pink to-opaque-pink flex rounded text-high-emphesis opacity-100 disabled:bg-opacity-80',
...
const FILLED = {
  ...
  pink: 'bg-gradient-to-r from-pink to-opaque-pink w-full rounded text-high-emphesis opacity-100 disabled:bg-opacity-80',
  gray: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-linear-gradient bg-opacity-80 w-full text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-800 disabled:bg-opacity-80',
  ...
  gradient:
    'w-full transition duration-1000 ease-in-out text-high-emphesis bg-linear-gradient disabled:bg-opacity-80 opacity-80 hover:opacity-100',
}
...
const OUTLINED = {
  ...
  gray: 'text-gray hover:bg-opacity-40 disabled:bg-opacity-20',
  ...
  gradient:
    'border border-transparent opacity-80 hover:opacity-100 disabled:bg-opacity-100 disabled:border-dark-800 disabled:bg-none disabled:bg-dark-700',
}
