...
export const getTokenLogoURL = (address: string, chainId: ChainId) => {
  return `https://raw.githubusercontent.com/BeamSwap/beamswap-tokenlist/main/assets/chains/${BLOCKCHAIN[chainId]}/${address}/logo.png`
}
...
function getCurrencyLogoUrls(currency) {
  ...
  if (currency.chainId in BLOCKCHAIN) {
    urls.push(
      `https://raw.githubusercontent.com/BeamSwap/beamswap-tokenlist/main/assets/chains/${
...
const BinanceCoinLogo =
  'https://raw.githubusercontent.com/BeamSwap/beamswap-tokenlist/main/assets/chains/smartchain/info/logo.png'
const EthereumLogo =
  'https://raw.githubusercontent.com/BeamSwap/beamswap-tokenlist/main/assets/chains/ethereum/info/logo.png'
...
const MoonbeamLogo = '/images/tokens/glimmer.png'
...
const MoonriverLogo = 'https://BeamSwap.io/images/tokens/moonriver.png'
...
const glint = 'https://beamswap.io/icon.png'
const share = '/images/tokens/share.png'
...
const CurrencyLogo: FunctionComponent<CurrencyLogoProps> = ({
  ...
  const srcs = useMemo(() => {
    ...
    if (currency?.symbol == 'GLINT') {
      return [glint]
    }
    if (currency?.symbol == 'SHARE') {
      return [share]
    }
