...
function renderTransactions(transactions: string[]) {
  return (
    <div className="flex flex-col flex-nowrap gap-2 mb-5">
...
const AccountDetails: FC<AccountDetailsProps> = ({
  ...
  function formatConnectorName() {
    ...
    return <div className="font-bold text-baseline text-jordyBlue">{i18n._(t`Connected with ${name}`)}</div>
  }
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <div className="space-y-3 pr-5 pl-5">
          ...
          <div id="web3-account-identifier-row" className="flex flex-col justify-center space-y-3">
            {ENSName ? (
              <div className="bg-inputBlue">
                {getStatusIcon()}
                <Typography>{ENSName}</Typography>
              </div>
            ) : (
              <div className="bg-deepCove py-2 px-3 rounded">
                {getStatusIcon()}
            ...
            <div className="flex items-center justify-between space-x-3 gap-2">
              ...
              {account && (
                <Copy className="text-aqua" toCopy={account}>
                  <Typography className="text-aqua" variant="sm">
      ...
      <div className="space-y-2 pr-5 pl-5">
        ...
        {!!pendingTransactions.length || !!confirmedTransactions.length ? (
          ...
          <Typography variant="sm" className="text-jordyBlue pb-8">
