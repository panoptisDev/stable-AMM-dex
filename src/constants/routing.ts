...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MOONBEAM_TESTNET]: [
    ...WRAPPED_NATIVE_ONLY[ChainId.MOONBEAM_TESTNET],
    MOONBEAM_TESTNET.GLMR,
    MOONBEAM_TESTNET.GLINT,
    MOONBEAM_TESTNET.MOCK,
  ],
  [ChainId.MOONBEAM]: [
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.MOONBEAM_TESTNET]: [
    ...
    MOONBEAM_TESTNET.GLINT,
    MOONBEAM_TESTNET.MOCK,
    MOONBEAM_TESTNET.WGLMR,
    MOONBEAM_TESTNET.ETH,
    MOONBEAM_TESTNET.BNB,
    MOONBEAM_TESTNET.DAI,
    MOONBEAM_TESTNET.WBTC,
    MOONBEAM_TESTNET.USDT,
    MOONBEAM_TESTNET.BUSD,
  ],
  [ChainId.MOONBEAM]: [
    ...WRAPPED_NATIVE_ONLY[ChainId.MOONBEAM],
    MOONBEAM.GLINT,
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MOONBEAM_TESTNET]: '0x7F9997c522Ff786bfC89FE826FA55b50CDDbdC59',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.ARBITRUM]: '',
  [ChainId.ARBITRUM_TESTNET]: '',
  [ChainId.MOONBEAM_TESTNET]: '0x7c81811f73734CE451412EE4B9AE9E0E168Fc0eb',
...
export const INIT_CODE_HASH: string = '0xe31da4209ffcce713230a74b5287fa8ec84797c9e77e1f7cfeccea015cdc97ea'
