...
export const MOONRIVER: { [key: string]: Token } = {
  ...
  GLINT: new Token(ChainId.MOONRIVER, '0xaBf3Cb26780a1882215621E4d9CEbCb6ca9fc9ef', 18, 'GLINT', 'Beamswap Token'),
  BUSD: new Token(
    ChainId.MOONRIVER,
...
export const MOONBEAM_TESTNET: { [key: string]: Token } = {
  GLINT: new Token(
  ...
  MOCK: new Token(ChainId.MOONBEAM_TESTNET, '0xC911e922c84A21c0803D8b9480a50d5CdFf61652', 18, 'MOCK', 'Mock token'),
  USDC: new Token(ChainId.MOONBEAM_TESTNET, '0x65C281140d15184de571333387BfCC5e8Fc7c8dc', 6, 'USDC', 'USDC token'),
  ETH: new Token(ChainId.MOONBEAM_TESTNET, '0x8cbF5008fa8De192209c6A987D0b3C9c3c7586a6', 18, 'ETH', 'ETH token'),
  BNB: new Token(ChainId.MOONBEAM_TESTNET, '0xD41A9bc8Df1Fc7520d0491bD627ea399b777C2f2', 18, 'BNB', 'BNB token'),
  DAI: new Token(ChainId.MOONBEAM_TESTNET, '0xEf4BC0F5a3870925157Ce9F5e86F8Ac25bE49f73', 18, 'DAI', 'DAI token'),
  WBTC: new Token(ChainId.MOONBEAM_TESTNET, '0xe87d5db6D8E884EA4128b9Fb2dd7c2961C67a409', 18, 'WBTC', 'WBTC token'),
  USDT: new Token(ChainId.MOONBEAM_TESTNET, '0x523D8e4Bbb37418f92A74d6D4bA1e225a0A2E176', 18, 'USDT', 'USDT token'),
  BUSD: new Token(ChainId.MOONBEAM_TESTNET, '0xe7b932a60E7d0CD08804fB8a3038bCa6218a7Fa2', 18, 'BUSD', 'BUSD token'),
}

export const MOONBEAM: { [key: string]: Token } = {
  // add everywhere
  GLINT: new Token(ChainId.MOONBEAM, '0xcd3B51D98478D53F4515A306bE565c6EebeF1D58', 18, 'GLINT', 'Beamswap Token'),
  WGLMR: new Token(ChainId.MOONBEAM, '0xAcc15dC74880C9944775448304B263D191c6077F', 18, 'WGLMR', 'Wrapped Glimmer'),
  USDC: new Token(ChainId.MOONBEAM, '0x818ec0A7Fe18Ff94269904fCED6AE3DaE6d6dC0b', 6, 'USDC', 'USDC token'),
  ETH: new Token(ChainId.MOONBEAM, '0xfA9343C3897324496A05fC75abeD6bAC29f8A40f', 18, 'ETH', 'ETH token'),
  BNB: new Token(ChainId.MOONBEAM, '0xc9BAA8cfdDe8E328787E29b4B078abf2DaDc2055', 18, 'BNB', 'BNB token'),
  DAI: new Token(ChainId.MOONBEAM, '0x765277EebeCA2e31912C9946eAe1021199B39C61', 18, 'DAI', 'DAI token'),
  WBTC: new Token(ChainId.MOONBEAM, '0x922D641a426DcFFaeF11680e5358F34d97d112E1', 18, 'WBTC', 'WBTC token'),
  USDT: new Token(ChainId.MOONBEAM, '0xeFAeeE334F0Fd1712f9a8cc375f427D9Cdd40d73', 6, 'USDT', 'USDT token'),
  BUSD: new Token(ChainId.MOONBEAM, '0xA649325Aa7C5093d12D6F98EB4378deAe68CE23F', 18, 'BUSD', 'BUSD token'),
}
...
export const GLINT_ADDRESS = {
  ...
  [ChainId.MOONRIVER]: '0xaBf3Cb26780a1882215621E4d9CEbCb6ca9fc9ef',
  [ChainId.MOONBEAM]: '0xcd3B51D98478D53F4515A306bE565c6EebeF1D58',
}

export const BEAMSHARE_ADDRESS = {
  [ChainId.MOONBEAM_TESTNET]: '0xF774C205a48ad0BEf7F62948FB69B31A8440e534',
  [ChainId.MOONBEAM]: '0x4204cAd97732282d261FbB7088e07557810A6408',
}

export const GLINT: ChainTokenMap = {
  [ChainId.MOONBEAM_TESTNET]: new Token(
    ChainId.MOONBEAM_TESTNET,
    GLINT_ADDRESS[ChainId.MOONBEAM_TESTNET],
    18,
    'GLINT',
    'Beamswap Token'
  ),
  [ChainId.MOONBEAM]: new Token(ChainId.MOONBEAM, GLINT_ADDRESS[ChainId.MOONBEAM], 18, 'GLINT', 'Beamswap Token'),
}

export const WETH9_EXTENDED: { [chainId: number]: Token } = {
  ...WETH9,
  // [SupportedChainId.MOONBEAM_TESTNET]: new Token(
  //   ChainId.MOONBEAM_TESTNET,
  //   '0x9dCca533798Aae4EC78cFEb057cb7745DcDe3048',
  //   18,
  //   'WGLMR',
