          ...
          <StyledMenu ref={node as any}>
            ...
            {open && (
              <PopoverContainer show={true} ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
                ...
                <UnpaddedLinkStyledButton onClick={handleRemoveList} disabled={Object.keys(listsByUrl).length === 0}>
                  Remove list
  ...
  return (
    <div className="relative flex-1 w-full h-full space-y-4 overflow-y-hidden">
      <input
        ...
        className="mt-4 w-full bg-blue border-dark-800 focus:border-transparent placeholder-secondary focus:placeholder-primary font-bold text-jordyBlue px-6 py-3.5 appearance-none"
        value={listUrlInput}
