...
export function CurrencySearch({
  ...
  return (
    <ContentWrapper>
      ...
      {!currencyList && (
        <div className="mt-3 mb-8 pr-6 pl-6">
          <input
            type="text"
            ...
            className="w-full bg-transparent focus:border-dark-400 bg-blue placeholder-secondary focus:placeholder-primary font-bold text-white px-3 py-3"
            style={{ color: '#81A1E1' }}
          />
        </div>
      )}
      ...
      {searchToken && !searchTokenIsAdded ? (
        ...
        <div className="flex-1 h-full pl-6 pr-6">
      ...
      {allowManageTokenList && (
        <div className="mt-3 bg-lightBlueSecondary flex justify-center">
          <img className="modal-close" src="/images/modal-manage-token-lists.svg" width="18px" height="18px" />
          <Button id="list-token-manage-button" onClick={showManageView} color="aqua" variant="link">
