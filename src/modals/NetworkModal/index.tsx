...
export const SUPPORTED_NETWORKS: {
  ...
  /* [ChainId.MOONBEAM_TESTNET]: {
    ...
    rpcUrls: ['https://rpc.api.moonbase.moonbeam.network', 'https://rpc.api.moonbase.moonbeam.network'],
  ...
  return (
    <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal} maxWidth={672}>
      ...
      <div className="mb-6 text-lg text-primary">
        You are currently browsing <span className="font-bold text-yellow">GLINT</span>
