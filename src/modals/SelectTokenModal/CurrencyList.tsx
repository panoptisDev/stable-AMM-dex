...
function CurrencyRow({
  ...
  const balance =
    currency.chainId == 250
      ? useMultichainCurrencyBalanceFTM(currency.chainId, account ?? undefined, currency)
      : useMultichainCurrencyBalance(currency.chainId, account ?? undefined, currency)
  ...
  return (
    <MenuItem
      id={`token-item-${key}`}
      style={style}
      className={`hover:bg-blue rounded`}
