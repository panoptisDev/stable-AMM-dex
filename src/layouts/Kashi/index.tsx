              ...
              <nav className="flex items-center justify-between w-full">
                <div className="flex">
                  <NavLink href="/lend">
                    ...
                    >
                      <div className="text-white whitespace-nowrap">Lend</div>
                    </a>
                  </NavLink>
                  <NavLink href="/borrow">
                    <a
                    ...
                    >
                      <div className="text-white whitespace-nowrap">Borrow</div>
                    </a>
                  </NavLink>
                  ...
                  <NavLink href="/kashi/create">
                    ...
                    >
                      <div className="text-white whitespace-nowrap">Create</div>
                    </a>
                  </NavLink>
                </div>
                <div className="flex pr-2 sm:pr-4">
                  <NavLink href="/balances">
                    ...
                    >
                      ...
                      <div className="text-white whitespace-nowrap">BentoBox</div>
                      {/* <div className="ml-2 text-white whitespace-nowrap">
                                                {formatNumber(
                                                    balances
